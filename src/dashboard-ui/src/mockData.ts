...
export const mockSettings: DashboardSettings = {
  ...
  integrations: [
    ...
    { id: 'olympus', name: 'DCS Olympus', description: 'Real-time mission control', kind: 'web-process', executablePath: 'C:\\Users\\dcs-server\\Saved Games\\DCS Olympus\\frontend\\server.vbs', arguments: '', configPath: 'C:\\Users\\dcs-server\\Saved Games\\DCS.server\\Config\\olympus.json', host: '127.0.0.1', port: 3000, srsAddress: '', telemetryAddress: '', url: 'http://127.0.0.1:3000', enabled: true, startWithDcs: true },
